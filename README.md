VisualMath Pro is a physical 3-dimensional function visualizer. It takes in a function (of notation f(x,y) = ....) and sends it to the physical model via Arduino.
